...
RC ExecuteStage::do_update(SQLStageEvent *sql_event)
{
  ...
  pred_oper.add_child(&scan_oper);
  UpdateOperator update_oper(update_stmt, trx,attr_name,value);
...
//   int updated_count = 0;
//   rc = handler_->update_record(trx, dbname, table_name, field_name, &updates.value)
